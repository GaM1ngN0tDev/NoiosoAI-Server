...
**NoiosoAI (User NoiosoAI-Desktop)** ▼ *(Sends chat prompts)* **Server (LLM Noioso Ollama Host)** ▼ *(Thinks & calls tools)* **Python Agent Web Script** ▼ *(Generates tool JSON / Runs commands)* **Server (Executor)** ```
